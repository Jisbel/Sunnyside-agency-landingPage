import { emily, jennie, thomas } from "../assets/images/index";

function Testimonial() {
  return (
    <section className="flex flex-col justify-center items-center my-20">
      <p className="font-fraunces900 tracking-[4px] text-grayishBlue mb-12">
        CLIENT TESTIMONIALS
      </p>
      <div className="grid md:grid-cols-3 justify-center items-center text-center gap-16">
        <div className="flex flex-col items-center md:h-full">
          ...
          <p className="font-fraunces900 text-lg text-charcoal mb-2">
            Emily R.
          </p>
          <p className="font-barlow text-sm text-grayishBlue">
            Marketing Director
          </p>
        </div>
        <div className="flex flex-col items-center md:h-full">
          <img
            ...
            className="rounded-full w-20 h-20 mb-8"
          />
          <p className="font-barlow text-cadet max-w-72 md:max-w-80 mb-6">
